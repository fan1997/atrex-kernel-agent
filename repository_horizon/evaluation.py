...
class PendingVerification:
    ...
    def as_dict(self) -> dict[str, Any]:
        ...
        value["expected_shape_ids"] = list(self.expected_shape_ids)
        return value
...
def append_evaluation_experiment(
    ...
    """Record one inline evaluation exactly once, including after a process restart."""
